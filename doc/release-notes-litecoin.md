Punkcoin Core version 0.13.3 is now available from:

  <https://download.punkcoin.org/punkcoin-0.13.3/>
...
Punkcoin Core now supports P2SH addresses beginning with M on mainnet and Q on testnet.
