...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s punkcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  punkcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded punkcoin transaction") + "\n" +
              "  punkcoin-tx [options] -create [commands]   " + _("Create hex-encoded punkcoin transaction") + "\n" +
              "\n";
