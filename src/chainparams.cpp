...
public:
    CMainParams() {
        ...
        vSeeds.push_back(CDNSSeedData("loshan.co.uk", "seed-a.punkcoin.loshan.co.uk", true));
        vSeeds.push_back(CDNSSeedData("thrasher.io", "dnsseed.thrasher.io", true));
        vSeeds.push_back(CDNSSeedData("punkcointools.com", "dnsseed.punkcointools.com"));
        vSeeds.push_back(CDNSSeedData("punkcoinpool.org", "dnsseed.punkcoinpool.org"));
...
public:
    CTestNetParams() {
        ...
        vSeeds.push_back(CDNSSeedData("punkcointools.com", "testnet-seed.punkcointools.com"));
        vSeeds.push_back(CDNSSeedData("loshan.co.uk", "seed-b.punkcoin.loshan.co.uk", true));
