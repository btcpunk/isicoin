...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/punkcoin-project/punkcoin>";
    const std::string URL_WEBSITE = "<https://punkcoin.org>";
