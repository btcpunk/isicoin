...
#if defined(NDEBUG)
# error "Punkcoin cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Punkcoin Signed Message:\n";
                              ...
                              std::vector<uint256>& vHashTxnToUncache)
{
...

    {
        ...
        {
            LogPrint("mempool", "replacing tx %s with %s for %s PNK additional fees, %d delta bytes\n",
...
void ThreadScriptCheck() {
    RenameThread("punkcoin-scriptch");
...
bool ContextualCheckBlockHeader(const CBlockHeader& block, CValidationState& state, const Consensus::Params& consensusParams, CBlockIndex * const pindexPrev, int64_t nAdjustedTime)
{
    ...
    // Punkcoin: Reject block.nVersion=1 blocks (mainnet >= 710000, testnet >= 400000, regtest uses supermajority)
...
bool ContextualCheckBlock(const CBlock& block, CValidationState& state, CBlockIndex * const pindexPrev)
{
    ...
    // Punkcoin: (mainnet >= 710000, regtest and testnet uses supermajority)
